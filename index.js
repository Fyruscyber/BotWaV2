...
const instagram = 'IndraFajri64'; // Nama Instagramlu cok
const nomer = 'https://Wa.me/+6285226087964'; // Nomor whatsapplu cok
const aktif = 'Ya Kalo Jaringan Mendukung'; // Kapan bot lu aktif
const groupwa = 'https://chat.whatsapp.com/KvnrobWpHgXEKqYwzQMTTi'; // OFFICIAL GRUP LU 1
const youtube = 'Fyrus'; // OFFICIAL GRUP LU 2
//
...
conn.sendMessage(id, 'Owner Fyrus wa.me/6285226087964' ,MessageType.text);
}
...
conn.sendMessage(id, 'Fyrus Lah add Fyrus wa.me/6285226087964' ,MessageType.text);
}
